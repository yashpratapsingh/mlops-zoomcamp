...
def run():
    if len(sys.argv) != 5:
        print("Usage: python ride_duration_prediction.py <taxi_type> <year> <month> <run_id>")
        sys.exit(1)

    taxi_type = sys.argv[1]  # 'green'
    year = int(sys.argv[2])  # e.g., 2023
    month = int(sys.argv[3]) # e.g., 4
    run_id = sys.argv[4]     # e.g., 'e1efc53e9bd149078b0c12aeaa6365df'
